...
/**
 * A
    n intermediate representation for a conditional transfer of control CJUMP(expr, trueLabel,
 * falseLabel)
 */
public class IRCJump extends IRStmt {
    ...
    public IRStmt replaceSubexprs(IRExpr sub, IRTemp t){
        return new IRCJump(cond.replaceSubexprs(sub, t), trueLabel, falseLabel);
    }

    @Override
    public Set<IRExpr> availableExpressions() {
        return cond.availableExpressions().part1();
    }
}
